    ...
    <div id="main-div">
        ...
        <div id="div-sx">
            ...
            <div id="sx-med">
                ...
                <h2 class="sx-evidenzia">AGGIUNGI NUOVO</h2>
        ...
        <div id="div-dx">
            ...
            <div style="margin-bottom: 5px;   height: 44px;">
                <div class="single-dx-title-div">
                    <h1 class="intestazione"><span class="glyphicon glyphicon-user"></span> REGISTRA NUOVO PAZIENTE</h1>
                </div>

                <div class="single_content_div" style="overflow-y: scroll; height:453px;">
                    <form type="input" action="#">

                        <h2 class="intestazione-scheda">Anagrafica</h2>
                        <input class="input-single" type="text" name="nome" placeholder="nome" required>
                        <input class="input-single"type="text" name="cognome" placeholder="cognome" required>
                        <input class="input-single" style="width: 140px;"type="date" name="nato" required>
                        <input class="input-single"type="text" name="citta_nato" placeholder="nato a" required>
                        <input class="input-single"style="width: 40px" type="text" name="prov_nato" placeholder="prov"required>
                        <input class="input-single"type="text" name="codice_fiscale" placeholder="codice fiscale" required>
                        <hr>
                        <h2 class="intestazione-scheda">Residenza</h2>
                        <input class="input-single"type="text" name="citta_residenza" placeholder="residente a" required>
                        <input class="input-single"style="width: 45px" type="text" name="prov_residenza" placeholder="prov" required>
                        <input class="input-single"style="width: 90px;" type="text" name="cap" placeholder="cap" required>
                        <input class="input-single"style="width: 536px"type="text" name="via" placeholder="via" required>
                        <input class="input-single"style="width: 50px" type="text" name="civico" placeholder="civico">
                        <hr>
                        <h2 class="intestazione-scheda">Recapito</h2>
                        <input class="input-single"type="text" name="telefono_fisso" placeholder="telefono fisso">
                        <input class="input-single"type="text" name="telefono_cel_uno" placeholder="cel">
                        <input class="input-single"type="text" name="telefono_cel_due" placeholder="altro cel">
                        <input class="input-single"style="width: 395px"type="text" name="mail" placeholder="e mail">
                        <hr>
                        <h2 class="intestazione-scheda">Patologia</h2>
                        <input class="input-single"type="text" name="patologia" placeholder="patologia">
                        <input class="input-single" style="width: 780px;"type="text" name="note_patologia" placeholder="note">
                        <hr>
                        <button class="form-button" type="submit" name "btn_salva_paziente"><span class="glyphicon glyphicon-floppy-save" aria-hidden="true"></span> Salva</button>
                        <button class="form-button" type="submit" name "btn_genera_pdf"><span class="glyphicon glyphicon-file" aria-hidden="true"></span> Genera PDF</button>
